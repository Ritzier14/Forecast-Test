...
Residual risks / follow-up packet: this is whole-file conflict detection, not field-level merge; users must Reload or Save As when the token changes. Backup integrity, retention, and restore remain LUNA-07; broader dialog extraction remains LUNA-15A.
